...
export const EVENT_ITEM_MEASUREMENT = "ITEM_MEASUREMENT";

export const EVENT_EXTERNAL_FLOORPLAN_LOADED =
...
export const EVENT_WALLS_COMPLETED = "WALLS_COMPLETED";

export const EVENT_LIGHT_SELECTED = "LIGHT_SELECTED_EVENT";
export const EVENT_NO_LIGHT_SELECTED = "LIGHT_NO_SELECTED_EVENT";
export const EVENT_LIGHT_REFRESH = "LIGHT_REFRESH_EVENT";
export const EVENT_LIGHT_LOAD = "LIGHT_LOAD_EVENT";
export const EVENT_LIGHT_RESET = "LIGHT_RESET_EVENT";
export const EVENT_LIGHT_CLICK = "LIGHT_CLICK_EVENT";
export const EVENT_ITEM_UPDATE = "ITEM_UPDATE_EVENT";
export const EVENT_ITEM_SELECTED = "ITEM_SELECTED_EVENT";

export const EVENT_ROTATE_SELECTED = "ROTATE_SELECTED_EVENT";

export const EVENT_ITEM_ROTATED = "ITEM_ROTATED_EVENT";
...
export const EVENT_CORNER_ATTRIBUTES_CHANGED =
...
export const EVENT_PARAMETRIC_GEOMETRY_UPATED =
