...
export class ParametricDoorType5 extends ParametricBaseDoor {
  ...
  __createForDoorModel(frameWidth, openingDirection) {
    ...
    let myvertex = [
      ...
      new Vector3(
        minx + 0.12030857801437378 * 100,
        -1.5832483768463135e-8 * 100,
        minz + 0.25000011920928955 * 100,
      ),
      new Vector3(
        minx + 0.12030857801437378 * 100,
      ...
      new Vector3(
        maxx - 0.1353275030851364 * 100,
        -0.009388341568410397 * 100,
        minz + 0.26250016689300537 * 100,
      ),
      new Vector3(
        maxx - 0.1353275030851364 * 100,
        -0.009388341568410397 * 100,
      ...
      new Vector3(
        maxx - 0.1353275179862976 * 100,
        maxy - 0.0006116721779108047 * 100,
        minz + 0.26250016689300537 * 100,
      ),
      new Vector3(
        maxx - 0.1353275179862976 * 100,
      ...
      new Vector3(
        maxx - 0.1353275179862976 * 100,
        maxy - 0.0012233462184667587 * 100,
        minz + 0.26250016689300537 * 100,
      ),
      new Vector3(
        minx + 0.13506758213043213 * 100,
    ...
    let glass_ids = [40, 41, 42, 83, 84, 85];
    let i = 0;
