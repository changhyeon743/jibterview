...
export class ParametricDoorType2 extends ParametricBaseDoor {
  ...
  __createForDoorModel(frameWidth, openingDirection) {
    ...
    let faceids = [
      0, 4, 15, 17, 0, 15, 3, 2, 21, 16, 3, 21, 4, 19, 23, 15, 4, 23, 10, 8, 6,
      7, 10, 6, 16, 21, 8, 10, 16, 8, 12, 3, 16, 18, 12, 16, 17, 15, 11, 9, 17,
      11, 23, 18, 20, 14, 23, 20, 19, 12, 18, 23, 19, 18, 9, 11, 5, 1, 9, 5, 11,
      14, 22, 5, 11, 22, 20, 10, 7, 13, 20, 7, 14, 20, 13, 22, 14, 13, 28, 10,
      20, 26, 28, 20, 25, 16, 10, 28, 25, 10, 30, 18, 16, 25, 30, 16, 26, 20,
      18, 30, 26, 18, 29, 11, 15, 27, 29, 15, 24, 23, 14, 31, 24, 14, 27, 15,
      23, 24, 27, 23, 31, 14, 11, 29, 31, 11, 32, 24, 31, 35, 32, 31, 33, 27,
      24, 32, 33, 24, 34, 29, 27, 33, 34, 27, 35, 31, 29, 34, 35, 29, 38, 28,
      26, 37, 38, 26, 37, 26, 30, 39, 37, 30, 36, 25, 28, 38, 36, 28, 39, 30,
      25, 36, 39, 25, 42, 34, 33, 41, 42, 33, 47, 39, 36, 44, 47, 36, 43, 35,
      34, 42, 43, 34, 46, 38, 37, 45, 46, 37, 41, 33, 32, 40, 41, 32, 44, 36,
      38, 46, 44, 38, 40, 32, 35, 43, 40, 35, 45, 37, 39, 47, 45, 39, 10, 20,
      18, 16, 10, 18, 15, 23, 14, 11, 15, 14, 48, 52, 63, 65, 48, 63, 51, 50,
      69, 64, 51, 69, 52, 67, 71, 63, 52, 71, 58, 56, 54, 55, 58, 54, 64, 69,
      56, 58, 64, 56, 60, 51, 64, 66, 60, 64, 65, 63, 59, 57, 65, 59, 71, 66,
      68, 62, 71, 68, 67, 60, 66, 71, 67, 66, 57, 59, 53, 49, 57, 53, 59, 62,
      70, 53, 59, 70, 68, 58, 55, 61, 68, 55, 62, 68, 61, 70, 62, 61, 76, 58,
      68, 74, 76, 68, 73, 64, 58, 76, 73, 58, 78, 66, 64, 73, 78, 64, 74, 68,
      66, 78, 74, 66, 77, 59, 63, 75, 77, 63, 72, 71, 62, 79, 72, 62, 75, 63,
      71, 72, 75, 71, 79, 62, 59, 77, 79, 59, 80, 72, 79, 83, 80, 79, 81, 75,
      72, 80, 81, 72, 82, 77, 75, 81, 82, 75, 83, 79, 77, 82, 83, 77, 86, 76,
      74, 85, 86, 74, 85, 74, 78, 87, 85, 78, 84, 73, 76, 86, 84, 76, 87, 78,
      73, 84, 87, 73, 90, 82, 81, 89, 90, 81, 95, 87, 84, 92, 95, 84, 91, 83,
      82, 90, 91, 82, 94, 86, 85, 93, 94, 85, 89, 81, 80, 88, 89, 80, 92, 84,
      86, 94, 92, 86, 88, 80, 83, 91, 88, 83, 93, 85, 87, 95, 93, 87, 58, 68,
      66, 64, 58, 66, 63, 71, 62, 59, 63, 62, 21, 2, 50, 69, 21, 50, 69, 56, 8,
      21, 69, 8, 56, 54, 6, 8, 56, 6, 7, 6, 54, 55, 7, 54, 13, 7, 55, 61, 13,
      55, 22, 13, 61, 70, 22, 61, 70, 53, 5, 22, 70, 5, 53, 49, 1, 5, 53, 1, 9,
      1, 49, 57, 9, 49, 17, 9, 57, 65, 17, 57, 65, 48, 0, 17, 65, 0, 4, 0, 48,
      52, 4, 48, 19, 4, 52, 67, 19, 52, 67, 60, 12, 19, 67, 12, 60, 51, 3, 12,
      60, 3, 51, 50, 2, 3, 51, 2,
    ];
    ...
    for (let i = 0; i < faceids.length; i += 3) {
      myfaces.push(
        vertices[faceids[i]],
        vertices[faceids[i + 1]],
        vertices[faceids[1 + 2]],
      );
    }
