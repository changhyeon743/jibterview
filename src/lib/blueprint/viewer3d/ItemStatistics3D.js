...
export class StatisticArrow extends Object3D {
  constructor(
    ...
    this.__reverseArrow = new ArrowHelper(
      this.__reverseArrowDirection,
      origin,
      length,
      hexColor,
      headLength,
  ...
  __createCanvasElement(canvas = undefined, parentElement = undefined, label) {
    ...
    context.fillText(
      label,
      textSize.x * 0.5 + padding * 0.5,
      textSize.y * 0.65 + padding * 0.5,
    );
  ...
  __createTextElement() {
    ...
    labelContext = this.__createCanvasElement(
      undefined,
      parentElement,
      "Ashok",
    );
    ...
    label3D.scale.set(
      labelSize.x * this.__textScaleFactor,
      labelSize.y * this.__textScaleFactor,
      1,
    );
    ...
    return {
      "three-element": label3D,
      "dom-element": labelElement,
      "label-holder": labelHolder,
      "text-texture": canvasTexture,
    };
  }
  ...
  __updateText(evt) {
    ...
    let label = `${value}`;
    let center = this.__arrowDirection
      .clone()
      .multiplyScalar(this.__arrowLength * 0.5);
  ...
  setLength(length, headLength, headWidth) {
    ...
    this.__arrow.setLength(
      this.__arrowLength,
      this.__arrowHeadLength,
      this.__arrowHeadWidth,
    );
    this.__reverseArrow.setLength(
      this.__arrowLength,
      this.__arrowHeadLength,
      this.__arrowHeadWidth,
    );
    this.__reverseArrow.position.copy(
      this.__arrowDirection.clone().multiplyScalar(this.__arrowLength),
    );
    this.__updateText();
  }
...
export class ItemStatistics3D extends Mesh {
  constructor(physicalItem, dragControls, opts) {
    ...
    let distanceTextBGColor = "#0f0f0f";
    ...
    this.__itemHalfSize = this.__physicalItem.box
      .getSize(new Vector3())
      .multiplyScalar(0.5);
    ...
    this.__upArrow = new StatisticArrow(
      this.__up.clone(),
      new Vector3(),
      1,
    ...
    this.__downArrow = new StatisticArrow(
      this.__down.clone(),
      new Vector3(),
      1,
      this.__options.distance.unselectedColor,
    ...
    this.__leftArrow = new StatisticArrow(
      this.__left.clone(),
      new Vector3(),
      1,
      this.__options.distance.unselectedColor,
    ...
    this.__rightArrow = new StatisticArrow(
      this.__right.clone(),
      new Vector3(),
      1,
      this.__options.distance.unselectedColor,
    ...
    this.__frontArrow = new StatisticArrow(
      this.__front.clone(),
      new Vector3(),
      1,
      this.__options.distance.unselectedColor,
    ...
    this.__backArrow = new StatisticArrow(
      this.__back.clone(),
      new Vector3(),
      1,
      this.__options.distance.unselectedColor,
    ...
    this.__widthArrow = new StatisticArrow(
      new Vector3(1, 0, 0),
      new Vector3(),
      50,
    ...
    this.__heightArrow = new StatisticArrow(
      new Vector3(0, 1, 0),
      new Vector3(),
      1,
      this.__options.dimension.unselectedColor,
    ...
    this.__depthArrow = new StatisticArrow(
      new Vector3(0, 0, -1),
      new Vector3(),
      1,
      this.__options.dimension.unselectedColor,
    ...
    this.__dragControls.addEventListener(
      EVENT_NO_ITEM_SELECTED,
      this.__deselectEvent,
    );
    this.__dragControls.addEventListener(
      EVENT_ITEM_SELECTED,
      this.__deselectEvent,
    ...
    Configuration.getInstance().addEventListener(
      EVENT_CHANGED,
      this.__configurationChangedEvent,
    );
  }
  ...
  __updateDimensionStatistics() {
    ...
    this.__widthArrow.setLength(
      this.__itemHalfSize.x * 2,
      this.__options.dimension.headLength,
      this.__options.dimension.headWidth,
    );
    this.__heightArrow.setLength(
      this.__itemHalfSize.y * 2,
      this.__options.dimension.headLength,
      this.__options.dimension.headWidth,
    );
    this.__depthArrow.setLength(
      this.__itemHalfSize.z * 2,
      this.__options.dimension.headLength,
      this.__options.dimension.headWidth,
    );
  ...
  __updateDistanceStatistics() {
    ...
    let physicalItems = excludeThyself(
      this.__physicalItem,
      this.__physicalItem.parent.physicalRoomItems,
    );
    intersectionsWithPlanes = intersectionsWithPlanes.concat(
    ...
    for (i = 0; i < this.__directions.length; i++) {
      ...
      intersections = this.__raycaster.intersectObjects(
        intersectionsWithPlanes,
        true,
      );
