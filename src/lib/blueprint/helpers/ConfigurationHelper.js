import {snapTolerance3D} from "@/lib/blueprint/core/configuration";
...
export class ConfigurationHelper {
  constructor() {
    ...
    this.__snapTolerance3D = Configuration.getNumericValue(snapTolerance3D);
  ...
  get _snapTolerance3D() {
    return this.__snapTolerance3D;
  }

  set _snapTolerance3D(value) {
    this.__snapTolerance3D = value;
  }
}
