...
export class Item extends EventDispatcher {
  ...
  set size(value) {
    this.__size = value;
    this.__halfSize = value.clone().multiplyScalar(0.5);
    this.__metadata.size = this.__size.toArray();
  ...
  get modelURL() {
    const storageURL = "/storage/v1/object/public/floorplan"
    const supabaseURL = process.env.NEXT_PUBLIC_SUPABASE_URL ?? ""
    return supabaseURL + storageURL + this.__metadata.modelURL;
  }
